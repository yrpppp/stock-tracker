...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const editStockIdInput = document.getElementById('edit-stock-id');
    const editSymbolInput = document.getElementById('edit-symbol');
    const editPurchasePriceInput = document.getElementById('edit-purchasePrice');
    ...
    function renderSummary(totalPurchase, totalCurrent) {
    ...
    function renderCard(stock, index, qty, isUSD, exRate) {
    ...
    editStockForm.addEventListener('submit', async (e) => {
        ...
        const editLoader = editStockForm.querySelector('.loader');
